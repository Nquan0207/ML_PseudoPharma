...
np.savez(os.path.join(preprocessed_dir, "train_data.npz"), x_train=x_train_selected, y_train=y_train)
np.savez(os.path.join(preprocessed_dir, "test_data.npz"), x_test=x_test_selected, y_test=y_test)
